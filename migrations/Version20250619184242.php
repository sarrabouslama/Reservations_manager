 ...
 */
final class Version20250619184242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE payement DROP reservation_id
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE payement ADD reservation_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
